...
export default async function TourDetails({ tour }) {
  ...
  return (
    <section className="lg:max-w-screen-lg mx-auto border rounded-md shadow-lg bg-slate-50 mt-6 mb-10">
      {/* mobile */}
      <div className="md:hidden w-max mx-auto mt-8 flex flex-col gap-4 justify-center items-start pb-6 ">
