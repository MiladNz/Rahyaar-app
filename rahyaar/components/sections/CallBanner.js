...
function CallBanner() {
  return (
    <section className="flex flex-col lg:flex-row lg:justify-between max-w-[310px] sm:max-w-[525px] md:max-w-[750px] lg:max-w-[1000px] relative w-full mx-auto my-24 border-2 rounded-lg shadow-sm border-primary dark:border-secondary">
      <div className="flex items-center border-b-2 lg:border-b-0 lg:border-l-2 rounded-t-lg bg-white dark:bg-gray-800 py-8 lg:w-3/4 border-primary dark:border-secondary">
        <div className="text-right px-2 lg:px-6 pb-1">
          <p className="text-xl md:text-3xl lg:text-4xl mb-3">
          ...
          <p className="text-textColor dark:text-gray-300 text-sm md:text-lg font-medium lg:text-left lg:text-2xl">
            به هر کجا که میخواهید!
          </p>
        </div>
        <Image
      ...
      <div className="flex lg:flex-col justify-around items-center p-4 lg:w-1/4 bg-white dark:bg-gray-800 rounded-b-lg lg:rounded-bl-none lg:rounded-r-lg">
        <div className="flex items-center gap-x-2">
          <p className="text-xl font-bold text-gray-800 dark:text-white">
            ۰۲۱-۱۸۴۰
          </p>
          <IoCall className="w-5 h-5 lg:w-6 lg:h-6 text-gray-800 dark:text-white" />
        </div>
        <button className="bg-primary dark:bg-secondary text-white px-7 py-2 rounded-lg hover:bg-primary/90 dark:hover:bg-secondary/80 dark:shadow-lg dark:shadow-white/30 dark:hover:shadow-white/50 transition-colors">
          اطلاعات بیشتر
        </button>
      </div>
    </section>
